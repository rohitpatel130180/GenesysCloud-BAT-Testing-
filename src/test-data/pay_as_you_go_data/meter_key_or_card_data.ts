export const whatDoYouNeedHelpWithJourney_Data = [
    {
        "QUE-What do you need help with?": "What do you need help with?",
        "MSG-Sorry. What do you need help with": "Sorry. What do you need help with",
...
export const meterKeyOrCardJourney_Data = [
    {
        ...
        "QUE-Are you off supply?":"Are you off supply? This means there's no power from the meter or you've ran out of credit.",
        "MSG-Sorry. Say yes or no for  off supply ":`Sorry. Say "yes" if you are off supply "no" if you are not off supply`,
         
        "QUE-AreYouOrSomeoneAbleToPickUpNewKeyCard?":"Are you or someone else able to pick up a new Key/card from a paypoint?",
